...
The first function, `ggplot()`, creates a coordinate system that you can add layers to. The first argument of `ggplot()` is the dataset to use https://twitter.com/HanaaTameez/status/1298256278876127234/photo/4e in the graph.
