...
MAYBE SAVE THE MATERIAL BELOW AND INSTEAD START WITH Basic R from 01-Chapter.Rmd.

## Visualizing data

We begin with learning how to visualizing data. There are three essential things to learn:

1. How to create graphs with a reusable template
2. How to add variables to a graph with aesthetics
3. How to select the 'type' of your graph
